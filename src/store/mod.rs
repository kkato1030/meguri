...
// Schema v1: the whole kernel schema in one migration (kernel-pruning
// Phase 6). A pre-v1 meguri.sqlite is not upgradable — the CREATE TABLEs will
// fail loudly on one; delete the db and restart (runs are ephemeral).
