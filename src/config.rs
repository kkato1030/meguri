...
impl Config {
    ...
    /// Reject project combinations the modes cannot honor: a non-local
    /// project without a `repo_slug` (nothing to talk to on GitHub), and a
    /// local project asking to `deliver = "pr"` (no push target).
