...
unset が要る等 —— `archive/p0-acp-spike` ブランチ 参照)。
...
**ACP を再検討するトリガー**: meguri が自前のチャット UI をホストする / 人間なしで自律 planning を回す / ACP がベンダー純正・1.0 まで成熟する。その時に `archive/p0-acp-spike` ブランチ から再開する。
